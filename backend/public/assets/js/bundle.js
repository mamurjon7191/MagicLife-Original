...
(() => {
  ...
  class ee {
    ...
    checkDestroyed() {
      if (this.isDeleted)
        throw Q.create("app-deleted", { appName: this._name });
    }
  }
  const te = "9.9.2";
  function re(e, t, r) {
    ...
    return (
      ie ||
        (ie = (function (
          ...
          throw Q.create("idb-open", { originalErrorMessage: e.message });
        })),
      ie
    );
  }
  ...
  class Qe {
    constructor(e, t, r) {
      ...
      (this.fullUserKey = Ze(this.userKey, n.apiKey, i)),
        (this.fullPersistenceKey = Ze("persistence", n.apiKey, i)),
    ...
    static async create(e, t, r = "authUser") {
      if (!t.length) return new Qe(Te(Ye), e, r);
      const n = (
        await Promise.all(
          t.map(async (e) => {
      ...
      let i = n[0] || Te(Ye);
      const s = Ze(r, e.config.apiKey, e.name);
      let o = null;
      for (const r of t)
        try {
    ...
    _initializeWithPersistence(e, t) {
      return (
        ...
        (this._initializationPromise = this.queue(async () => {
          ...
          if (
            !this._deleted &&
            ((this.persistenceManager = await Qe.create(this, e)),
            !this._deleted)
          ) {
            if (
  ...
  class Qt {
    ...
    async _isAvailable() {
      try {
        ...
        const e = await Xt();
        return await Yt(e, Lt, "1"), await Zt(e, Lt), !0;
      } catch (e) {}
      return !1;
    }
    ...
    async _remove(e) {
      return this._withPendingWrite(
        async () => (
          await this._withRetries((t) => Zt(t, e)),
      ...
      if (!e) {
        try {
          const t = await (async function (e, t) {
              const r = (function (e) {
                  return Ze("pendingRedirect", e.config.apiKey, e.name);
                })(t),
                n = (function (e) {
  ...
  ($r = "Browser"),
    ...
    (function (e, t = {}) {
      ...
      if ("string" != typeof n || !n)
        throw Q.create("bad-app-name", { appName: String(n) });
      const i = G.get(n);
      if (i) {
        if (c(e, i.options) && c(r, i.config)) return i;
        throw Q.create("duplicate-app", { appName: n });
      }
      const s = new _(n);
      ...
      apiKey: "AIzaSyDrvkEIppFf7i_Js4-VBi5MBlScsMpVFPU",
      authDomain: "test-2c793.firebaseapp.com",
      projectId: "test-2c793",
      storageBucket: "test-2c793.appspot.com",
      messagingSenderId: "253768713122",
      appId: "1:253768713122:web:7b86e2f3531bbad7ea28fb",
      measurementId: "G-6NJWL7Z2ZW",
    });
  const Xr = Jr();
  (Xr.languageCode = "ru"),
    (window.recaptchaVerifier = new (class {
      ...
      "send",
      {
        size: "invisible",
        callback: (e) => {
          console.log("kod keldi");
        },
      },
      Xr
    )),
    document.querySelector("#send").addEventListener("click", function () {
      const e = document.querySelector("#numberPhone").value,
    ...
    document.querySelector("#verify").addEventListener("click", function () {
      const e = document.querySelector(".verification-code").value;
      window.confirmationResult
        ...
        .catch((e) => {
          console.log(e),
            alert(
              "Siz tizimga kirolmadingiz .Iltimos ayta harakat qilib koring"
            );
        });
    });
})();
